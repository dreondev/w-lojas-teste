...
const sheetVariants = cva(
  "fixed mr-[10px] mt-[10px] bg-[#05111b] z-50 gap-4 p-6 rounded-[10px] border border-slate-900 shadow-lg transition ease-in-out",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 data-[state=closed]:animate-slide-out-to-top data-[state=open]:animate-slide-in-from-top",
        bottom:
          "inset-x-0 bottom-0 data-[state=closed]:animate-slide-out-to-bottom data-[state=open]:animate-slide-in-from-bottom", // Tailwind animation classes
